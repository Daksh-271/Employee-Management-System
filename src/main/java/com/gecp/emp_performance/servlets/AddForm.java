...
public class AddForm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String assigned_emp_id = (String) sess.getAttribute("manager_id");
            ...
            out.println("            <input type=\"text\" name=\"username\" placeholder=\"Enter Your Name\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            ...
            out.println("            <input type=\"email\" name=\"email\" placeholder=\"Enter Your Email Address\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            ...
            out.println("            <input type=\"number\" name=\"age\" placeholder=\"Enter Your Age\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            ...
            out.println("            <input type=\"text\" name=\"employee_id\" placeholder=\"Enter Employee ID\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("          ");
            out.println("");
            ...
            out.println("          <div class=\"sec-2\">");
            out.println("            <ion-icon name=\"id-card-outline\"></ion-icon>");
            out.println("            <input type=\"text\" name=\"assigned-employer_id\" placeholder=\"Enter ID of Assigned Employer\" value='"+ assigned_emp_id +"' readonly required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("          ");
            ...
            out.println("            <input type=\"text\" name=\"department\" placeholder=\"Enter Department\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            ...
            out.println("            <input type=\"text\" name=\"education\" placeholder=\"Enter Education\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            out.println("");
            ...
            out.println("            <input type=\"text\" name=\"recruitment_type\" placeholder=\"Enter Recruitment Type\" required/>");
            out.println("          </div>");
            out.println("        </div>  ");
            out.println("          ");
            ...
            out.println("            <input type=\"number\" name=\"job_rating\" placeholder=\"Enter Job Rating(0-5)\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            ...
            out.println("            <input type=\"number\" name=\"awards\" placeholder=\"Enter Number of Awards\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            ...
            out.println("            <input type=\"number\" name=\"salary\" placeholder=\"Enter Salary\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            out.println("        <center><button type=\"button\" class=\"login\" onclick=\"prevPage()\" style=\"margin-top:10px;\">Previous</button>");
            ...
            out.println("            <input type=\"text\" name=\"satisfaction\" placeholder=\"Enter Yes or No\" required/>");
            out.println("          </div>");
            out.println("        </div>");
            out.println("");
            out.println("        <center><button type=\"button\" class=\"login\" onclick=\"prevPage()\" style=\"margin-top:10px;\">Previous</button>");
            out.println("            <button type=\"submit\" class=\"login\" style=\"margin-top:10px;\">Add</button>");
            out.println("            ");
            out.println("        <div class=\"footer\" id=\"foot\">");
